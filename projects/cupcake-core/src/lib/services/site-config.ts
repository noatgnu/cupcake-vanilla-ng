...
export class SiteConfigService {
  ...
  private fetchConfigFromBackend(): Observable<Partial<SiteConfig>> {
    return this.http.get<Partial<SiteConfig>>(`${this.config.apiUrl}/site-config/public/`);
  }
  ...
  getCurrentConfig(): Observable<SiteConfig> {
    return this.http.get<SiteConfig>(`${this.config.apiUrl}/site-config/current/`);
  }
  ...
  updateConfig(config: Partial<SiteConfig>): Observable<SiteConfig> {
    return this.http.put<SiteConfig>(`${this.config.apiUrl}/site-config/update_config/`, config);
  }
